(() => {
  ...
  $('heroTagline').textContent = cfg.heroTagline || 'Purple. Unbothered. Everywhere.';
  $('heroSubline').textContent = cfg.heroSubline || 'Meet DIK — one eggplant, too many situations.';
  $('year').textContent = `© ${new Date().getFullYear()} DIK`;
